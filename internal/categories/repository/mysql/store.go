...
func (s *categoryRepository) UpdateCategory(ctx context.Context, category *categorymodel.CategoryUpdate) error {
	if err := s.db.Table("categories").Save(category).Error; err != nil {
